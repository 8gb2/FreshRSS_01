...
SQL;
	...
	public function searchById(int $id): ?FreshRSS_Feed {
		...
		/** @var array<int,array{'url':string,'kind':int,'category':int,'name':string,'website':string,'iconFeed':string,'iconUser':string,'lastUpdate':int,
	...
	public function listFeeds(): array {
		...
		/** @var array<array{'url':string,'kind':int,'category':int,'name':string,'website':string,'iconFeed':string,'iconUser':string,'lastUpdate':int,
...
SQL;
	...
	/**
	 * @param array<int,array{'id'?:int,'url'?:string,'kind'?:int,'category'?:int,'name'?:string,'website'?:string,'iconFeed':string,'iconUser':string,'description'?:string,'lastUpdate'?:int,'priority'?:int,
